...
export default function FooterWithSocialLinks() {
  return (
    <footer className="relative w-full bg-green-700 ">
      <div className="mx-auto w-full max-w-7xl px-8 ">
        ...
        <div className="mt-12 flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
          <Typography
            variant="small"
            className="mb-4 text-base text-center font-normal text-white md:mb-0"
          >
            &copy; {currentYear}{" "}
            <a href="https://material-tailwind.com/">TopFarm </a>. All
            Rights Reserved.
          </Typography>
