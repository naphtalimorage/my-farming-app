...
import Farmer from "../assets/download1.jpeg";
import Autoplay from "embla-carousel-autoplay";
import { Link } from "react-router-dom";

const CarouselPage = () => {
  const imagesItems = [
    { src: Farmer, alt: "Vegetables1" },
    { src: Farmer, alt: "Vegetables2" },
    { src: Farmer, alt: "Vegetables3" },
  ];
    ...
    <>
      <div className="">
        ...
        >
          <CarouselContent>
            {imagesItems &&
              imagesItems.map((image) => (
                <CarouselItem
                  key={image.alt}
                  className="relative h-[320px] lg:h-[460px] w-full"
                >
